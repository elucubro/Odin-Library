...
function Book(bookName, author, pageCount, bookStatus) {
    ...
    this.info = function () {
        return (bookName + ", " + author + ", " + pageCount.toString() + ", " + bookStatus);
    };
}
function addBookToLibrary(titleInput, authorInput, pageCount, statusInput) {
    let page = Number(pageCount);
    let newBook = new Book(titleInput, authorInput, page, statusInput);
...
const theHobbit = new Book("The Hobbit", "JRR Tolkien", 134, "True");
